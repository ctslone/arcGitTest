"use strict";
(self["webpackChunkcdata_arc"] = self["webpackChunkcdata_arc"] || []).push([["src_flows_flowapi_SampleCodeMirror_tsx","src_components_arc-codemirror_index_jsx"],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ SampleCodeMirror)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(96540);
/* harmony import */ var _components_arc_codemirror__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(98251);
/* harmony import */ var _codemirror_lang_xml__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(97701);
/* harmony import */ var _codemirror_lang_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(28858);
/* harmony import */ var _data_flowapi__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(19373);





function SampleCodeMirror(props) {
    const extensions = react__WEBPACK_IMPORTED_MODULE_0__.useMemo(() => {
        if (props.contentType === _data_flowapi__WEBPACK_IMPORTED_MODULE_2__/* .ContentTypeType */ .Wj.JSON)
            return [(0,_codemirror_lang_json__WEBPACK_IMPORTED_MODULE_3__/* .json */ .Pq)()];
        else if (props.contentType === _data_flowapi__WEBPACK_IMPORTED_MODULE_2__/* .ContentTypeType */ .Wj.XML)
            return [(0,_codemirror_lang_xml__WEBPACK_IMPORTED_MODULE_4__/* .xml */ ._n)()];
        else
            return [];
    }, [props.contentType]);
    return react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_arc_codemirror__WEBPACK_IMPORTED_MODULE_1__["default"], { key: props.contentType, text: props.sample, onChange: props.onChange, extensions: extensions, readOnly: props.readOnly, autoFocus: false });
}

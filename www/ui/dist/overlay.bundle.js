"use strict";
(self["webpackChunkcdata_arc"] = self["webpackChunkcdata_arc"] || []).push([["overlay"],{
...
var floating_ui_dom = __webpack_require__(17663);
...
;// CONCATENATED MODULE: ./src/components/arc-overlay/index.jsx
...
/*
* To render a tooltip component once across whole application is enough.
* It is recommended that places the tooltip component directly inside the root component of your application
* */

function ArcPopover() {
  return /*#__PURE__*/react.createElement(M, {
    id: "reactPopover",
    className: "popover text-wrap text-break",
    variant: "light",
    opacity: 1,
    openEvents: {
      mouseenter: true
...
function ArcTooltip() {
  return /*#__PURE__*/react.createElement(M, {
    id: "reactTooltip",
    className: "tooltip text-wrap text-break",
    variant: "dark",
    opacity: 1
  });
}
client.createRoot(document.getElementById("overlayContainer")).render(/*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(ArcPopover, null), /*#__PURE__*/react.createElement(ArcTooltip, null)));
...
/******/ __webpack_require__.O(0, ["react","vendors"], () => (__webpack_exec__(55469)));

(self["webpackChunkcdata_arc"] = self["webpackChunkcdata_arc"] || []).push([["vendors-node_modules_codemirror_autocomplete_dist_index_js-node_modules_codemirror_commands_d-ffc779"],{

/***/ 20928:
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

const { xmlLexer } = __webpack_require__(95126);
const { xmlParser } = __webpack_require__(56121);
...
const { createToken: createTokenOrg, Lexer } = __webpack_require__(97712);
...
const { CstParser, tokenMatcher } = __webpack_require__(97712);
const { tokensDictionary: t } = __webpack_require__(95126);
...
var utils = __webpack_require__(31632);
// EXTERNAL MODULE: ./node_modules/regexp-to-ast/lib/regexp-to-ast.js
var regexp_to_ast = __webpack_require__(62475);
...
/* harmony import */ var _codemirror_state__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(31638);
/* harmony import */ var _codemirror_view__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(36898);
/* harmony import */ var _codemirror_language__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(15874);
...
*/
const pickedCompletion = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .Annotation */ .YH.define();
/**
...
function insertCompletionText(state, text, from, to) {
    ...
    return Object.assign(Object.assign({}, state.changeByRange(range => {
        ...
        return {
            ...
            range: _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.cursor(range.from + fromOff + lines.length)
        };
...
class FuzzyMatcher {
    ...
    match(word) {
        ...
        // at the start
        if (chars.length == 1) {
            let first = (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .codePointAt */ .vS)(word, 0), firstSize = (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .codePointSize */ .Fh)(first);
        ...
        for (let i = 0, e = Math.min(word.length, 200), prevType = 0 /* Tp.NonWord */; i < e && byWordTo < len;) {
            ...
            let ch, type = next < 0xff
                ...
                : ((ch = (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .fromCodePoint */ .MK)(next)) != ch.toLowerCase() ? 1 /* Tp.Upper */ : ch != ch.toUpperCase() ? 2 /* Tp.Lower */ : 0 /* Tp.NonWord */);
...
function defaultPositionInfo(view, list, option, info, space, tooltip) {
    let rtl = view.textDirection == _codemirror_view__WEBPACK_IMPORTED_MODULE_2__/* .Direction */ .OP.RTL, left = rtl, narrow = false;
    ...
    eventHandlers: {
        blur(event) {
            ...
            if (state && state.tooltip && this.view.state.facet(completionConfig).closeOnBlur) {
                let dialog = state.open && (0,_codemirror_view__WEBPACK_IMPORTED_MODULE_2__/* .getTooltip */ .Eg)(this.view, state.open.tooltip);
...
const commitCharacters = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .Prec */ .Nb.highest(/*@__PURE__*/_codemirror_view__WEBPACK_IMPORTED_MODULE_2__/* .EditorView */ .Lz.domEventHandlers({
    keydown(event, view) {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Cv: () => (/* binding */ cursorCharLeft),
/* harmony export */   Ub: () => (/* binding */ selectAll),
/* harmony export */   Yc: () => (/* binding */ indentWithTab),
/* harmony export */   ZR: () => (/* binding */ standardKeymap),
/* harmony export */   ZS: () => (/* binding */ redo),
/* harmony export */   b6: () => (/* binding */ history),
/* harmony export */   be: () => (/* binding */ deleteCharForward),
/* harmony export */   cL: () => (/* binding */ historyKeymap),
/* harmony export */   mL: () => (/* binding */ redoDepth),
/* harmony export */   mk: () => (/* binding */ undoDepth),
/* harmony export */   pw: () => (/* binding */ defaultKeymap),
/* harmony export */   tN: () => (/* binding */ undo),
/* harmony export */   xt: () => (/* binding */ cursorCharRight)
/* harmony export */ });
/* unused harmony exports blockComment, blockUncomment, copyLineDown, copyLineUp, cursorCharBackward, cursorCharBackwardLogical, cursorCharForward, cursorCharForwardLogical, cursorDocEnd, cursorDocStart, cursorGroupBackward, cursorGroupForward, cursorGroupForwardWin, cursorGroupLeft, cursorGroupRight, cursorLineBoundaryBackward, cursorLineBoundaryForward, cursorLineBoundaryLeft, cursorLineBoundaryRight, cursorLineDown, cursorLineEnd, cursorLineStart, cursorLineUp, cursorMatchingBracket, cursorPageDown, cursorPageUp, cursorSubwordBackward, cursorSubwordForward, cursorSyntaxLeft, cursorSyntaxRight, deleteCharBackward, deleteCharBackwardStrict, deleteGroupBackward, deleteGroupForward, deleteLine, deleteLineBoundaryBackward, deleteLineBoundaryForward, deleteToLineEnd, deleteToLineStart, deleteTrailingWhitespace, emacsStyleKeymap, historyField, indentLess, indentMore, indentSelection, insertBlankLine, insertNewline, insertNewlineAndIndent, insertNewlineKeepIndent, insertTab, invertedEffects, isolateHistory, lineComment, lineUncomment, moveLineDown, moveLineUp, redoSelection, selectCharBackward, selectCharBackwardLogical, selectCharForward, selectCharForwardLogical, selectCharLeft, selectCharRight, selectDocEnd, selectDocStart, selectGroupBackward, selectGroupForward, selectGroupForwardWin, selectGroupLeft, selectGroupRight, selectLine, selectLineBoundaryBackward, selectLineBoundaryForward, selectLineBoundaryLeft, selectLineBoundaryRight, selectLineDown, selectLineEnd, selectLineStart, selectLineUp, selectMatchingBracket, selectPageDown, selectPageUp, selectParentSyntax, selectSubwordBackward, selectSubwordForward, selectSyntaxLeft, selectSyntaxRight, simplifySelection, splitLine, temporarilySetTabFocusMode, toggleBlockComment, toggleBlockCommentByLine, toggleComment, toggleLineComment, toggleTabFocusMode, transposeChars, undoSelection */
/* harmony import */ var _codemirror_state__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(31638);
/* harmony import */ var _codemirror_view__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(36898);
/* harmony import */ var _codemirror_language__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(15874);
...
const fromHistory = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .Annotation */ .YH.define();
/**
...
*/
const isolateHistory = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .Annotation */ .YH.define();
/**
...
*/
const invertedEffects = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .Facet */ .sj.define();
const historyConfig = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .Facet */ .sj.define({
    combine(configs) {
        return (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .combineConfig */ .QR)(configs, {
            minDepth: 100,
            newGroupDelay: 500,
...
const historyField_ = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .StateField */ .sU.define({
    create() {
    ...
    update(state, tr) {
        ...
        if (isolate == "full" || isolate == "before")
            state = state.isolate();
        if (tr.annotation(_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .Transaction */ .ZX.addToHistory) === false)
            return !tr.changes.empty ? state.addMapping(tr.changes.desc) : state;
        let event = HistEvent.fromTransaction(tr);
        let time = tr.annotation(_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .Transaction */ .ZX.time), userEvent = tr.annotation(_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .Transaction */ .ZX.userEvent);
        if (event)
...
function history(config = {}) {
    return [
        ...
        _codemirror_view__WEBPACK_IMPORTED_MODULE_2__/* .EditorView */ .Lz.domEventHandlers({
            beforeinput(e, view) {
...
class HistEvent {
    ...
    static fromJSON(json) {
        return new HistEvent(json.changes && _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .ChangeSet */ .VR.fromJSON(json.changes), [], json.mapped && _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .ChangeDesc */ .Gu.fromJSON(json.mapped), json.startSelection && _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.fromJSON(json.startSelection), json.selectionsAfter.map(_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.fromJSON));
    }
...
function mapEvent(event, mapping, extraSelections) {
    ...
    return new HistEvent(mappedChanges, _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .StateEffect */ .Pe.mapEffects(event.effects, mapping), fullMapping, event.startSelection.map(before), selections);
}
...
class HistoryState {
    ...
    addChanges(event, time, userEvent, config, tr) {
        ...
        if (lastEvent && lastEvent.changes && !lastEvent.changes.empty && event.changes &&
            ...
            done = updateBranch(done, done.length - 1, config.minDepth, new HistEvent(event.changes.compose(lastEvent.changes), conc(_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .StateEffect */ .Pe.mapEffects(event.effects, lastEvent.changes), lastEvent.effects), lastEvent.mapped, lastEvent.startSelection, none));
        }
        else {
...
function updateSel(sel, by) {
    return _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.create(sel.ranges.map(by), sel.mainIndex);
}
...
function rangeEnd(range, forward) {
    return _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.cursor(forward ? range.to : range.from);
}
function cursorByChar(view, forward) {
    return moveSel(view, range => range.empty ? view.moveByChar(range, forward) : rangeEnd(range, forward));
}
function ltrAtCursor(view) {
    return view.textDirectionAt(view.state.selection.main.head) == _codemirror_view__WEBPACK_IMPORTED_MODULE_2__/* .Direction */ .OP.LTR;
}
/**
...
function moveBySyntax(state, start, forward) {
    ...
    let bracketProp = forward ? _lezer_common__WEBPACK_IMPORTED_MODULE_0__/* .NodeProp */ .uY.closedBy : _lezer_common__WEBPACK_IMPORTED_MODULE_0__/* .NodeProp */ .uY.openedBy;
    ...
    return _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.cursor(newPos, forward ? -1 : 1);
}
/**
...
function pageInfo(view) {
    ...
    if (selfScroll) {
        for (let source of view.state.facet(_codemirror_view__WEBPACK_IMPORTED_MODULE_2__/* .EditorView */ .Lz.scrollMargins)) {
...
function cursorByPage(view, forward) {
    ...
    if (page.selfScroll) {
        ...
        if (startPos && startPos.top > scrollTop && startPos.bottom < scrollBottom)
            effect = _codemirror_view__WEBPACK_IMPORTED_MODULE_2__/* .EditorView */ .Lz.scrollIntoView(selection.main.head, { y: "start", yMargin: startPos.top - scrollTop });
    }
...
function moveByLineBoundary(view, start, forward) {
    ...
    if (!forward && moved.head == line.from && line.length) {
        ...
        if (space && start.head != line.from + space)
            moved = _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.cursor(line.from + space);
    }
    return moved;
}
/**
...
*/
const cursorLineStart = view => moveSel(view, range => _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.cursor(view.lineBlockAt(range.head).from, 1));
/**
Move the selection to the end of the line.
*/
const cursorLineEnd = view => moveSel(view, range => _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.cursor(view.lineBlockAt(range.head).to, -1));
function toMatchingBracket(state, dispatch, extend) {
    let found = false, selection = updateSel(state.selection, range => {
        ...
        return extend ? _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.range(range.anchor, head) : _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.cursor(head);
    });
    if (!found)
        return false;
    dispatch(setSel(state, selection));
...
function extendSel(target, how) {
    let selection = updateSel(target.state.selection, range => {
        let head = how(range);
        return _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.range(range.anchor, head.head, head.goalColumn, head.bidiLevel || undefined);
    });
...
*/
const selectLineStart = view => extendSel(view, range => _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.cursor(view.lineBlockAt(range.head).from));
/**
Move the selection head to the end of the line.
*/
const selectLineEnd = view => extendSel(view, range => _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.cursor(view.lineBlockAt(range.head).to));
/**
...
const selectLine = ({ state, dispatch }) => {
    let ranges = selectedLineBlocks(state).map(({ from, to }) => _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.range(from, Math.min(to + 1, state.doc.length)));
    dispatch(state.update({ selection: _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.create(ranges), userEvent: "select" }));
    return true;
};
/**
    ...
    let selection = updateSel(state.selection, range => {
        ...
        for (let cur = stack; cur; cur = cur.next) {
            ...
            if (((node.from < range.from && node.to >= range.to) ||
                ...
                cur.next)
                return _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.range(node.to, node.from);
        }
        return range;
    });
    if (selection.eq(state.selection))
...
const simplifySelection = ({ state, dispatch }) => {
    ...
    if (cur.ranges.length > 1)
        selection = _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.create([cur.main]);
    else if (!cur.main.empty)
        selection = _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.create([_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.cursor(cur.main.head)]);
    if (!selection)
        return false;
    dispatch(setSel(state, selection));
    return true;
...
function deleteBy(target, by) {
    ...
    let changes = state.changeByRange(range => {
        ...
        return from == to ? { range } : { changes: { from, to }, range: _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.cursor(from, from < range.head ? -1 : 1) };
    });
    ...
    target.dispatch(state.update(changes, {
        scrollIntoView: true,
        userEvent: event,
        effects: event == "delete.selection" ? _codemirror_view__WEBPACK_IMPORTED_MODULE_2__/* .EditorView */ .Lz.announce.of(state.phrase("Selection deleted")) : undefined
    }));
    return true;
}
function skipAtomic(target, pos, forward) {
    if (target instanceof _codemirror_view__WEBPACK_IMPORTED_MODULE_2__/* .EditorView */ .Lz)
        for (let ranges of target.state.facet(_codemirror_view__WEBPACK_IMPORTED_MODULE_2__/* .EditorView */ .Lz.atomicRanges).map(f => f(target)))
...
const deleteByChar = (target, forward, byIndentUnit) => deleteBy(target, range => {
    ...
    if (byIndentUnit && !forward && pos > line.from && pos < line.from + 200 &&
        ...
        if (before[before.length - 1] == "\t")
            return pos - 1;
        let col = (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .countColumn */ .y$)(before, state.tabSize), drop = col % (0,_codemirror_language__WEBPACK_IMPORTED_MODULE_3__/* .getIndentUnit */ .tp)(state) || (0,_codemirror_language__WEBPACK_IMPORTED_MODULE_3__/* .getIndentUnit */ .tp)(state);
        for (let i = 0; i < drop && before[before.length - 1 - i] == " "; i++)
            pos--;
        targetPos = pos;
    }
    else {
        targetPos = (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .findClusterBreak */ .zK)(line.text, pos - line.from, forward, forward) + line.from;
        if (targetPos == pos && line.number != (forward ? state.doc.lines : 1))
            targetPos += forward ? 1 : -1;
        else if (!forward && /[\ufe00-\ufe0f]/.test(line.text.slice(targetPos - line.from, pos - line.from)))
            targetPos = (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .findClusterBreak */ .zK)(line.text, targetPos - line.from, false, false) + line.from;
    }
    return targetPos;
});
/**
...
const deleteByGroup = (target, forward) => deleteBy(target, range => {
    ...
    for (let cat = null;;) {
        ...
        let next = (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .findClusterBreak */ .zK)(line.text, pos - line.from, forward) + line.from;
...
const splitLine = ({ state, dispatch }) => {
    if (state.readOnly)
        return false;
    let changes = state.changeByRange(range => {
        return { changes: { from: range.from, to: range.to, insert: _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .Text */ .EY.of(["", ""]) },
            range: _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.cursor(range.from) };
    });
...
const transposeChars = ({ state, dispatch }) => {
    ...
    let changes = state.changeByRange(range => {
        ...
        let from = pos == line.from ? pos - 1 : (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .findClusterBreak */ .zK)(line.text, pos - line.from, false) + line.from;
        let to = pos == line.to ? pos + 1 : (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .findClusterBreak */ .zK)(line.text, pos - line.from, true) + line.from;
        return { changes: { from, to, insert: state.doc.slice(pos, to).append(state.doc.slice(from, pos)) },
            range: _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.cursor(to) };
    });
    if (changes.changes.empty)
        return false;
...
function moveLine(state, dispatch, forward) {
    ...
    for (let block of selectedLineBlocks(state)) {
        ...
        if (forward) {
            ...
            for (let r of block.ranges)
                ranges.push(_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.range(Math.min(state.doc.length, r.anchor + size), Math.min(state.doc.length, r.head + size)));
        }
        else {
            changes.push({ from: nextLine.from, to: block.from }, { from: block.to, insert: state.lineBreak + nextLine.text });
            for (let r of block.ranges)
                ranges.push(_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.range(r.anchor - size, r.head - size));
        }
    }
    if (!changes.length)
        return false;
    dispatch(state.update({
        changes,
        scrollIntoView: true,
        selection: _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.create(ranges, state.selection.mainIndex),
        userEvent: "move.line"
    }));
    return true;
}
...
function isBetweenBrackets(state, pos) {
    ...
    if (before && after && before.to <= pos && after.from >= pos &&
        (closedBy = before.type.prop(_lezer_common__WEBPACK_IMPORTED_MODULE_0__/* .NodeProp */ .uY.closedBy)) && closedBy.indexOf(after.name) > -1 &&
...
function newlineAndIndent(atEof) {
    return ({ state, dispatch }) => {
        ...
        let changes = state.changeByRange(range => {
            ...
            if (indent == null)
                indent = (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .countColumn */ .y$)(/^\s*/.exec(state.doc.lineAt(from).text)[0], state.tabSize);
            ...
            return { changes: { from, to, insert: _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .Text */ .EY.of(insert) },
                range: _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.cursor(from + 1 + insert[1].length) };
        });
        dispatch(state.update(changes, { scrollIntoView: true, userEvent: "input" }));
        return true;
    };
...
function changeBySelectedLine(state, f) {
    ...
    return state.changeByRange(range => {
        ...
        let changeSet = state.changes(changes);
        return { changes,
            range: _codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .EditorSelection */ .OF.range(changeSet.mapPos(range.anchor, 1), changeSet.mapPos(range.head, 1)) };
    });
}
/**
...
const indentLess = ({ state, dispatch }) => {
    ...
    dispatch(state.update(changeBySelectedLine(state, (line, changes) => {
        ...
        if (!space)
            return;
        let col = (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_1__/* .countColumn */ .y$)(space, state.tabSize), keep = 0;
...
var view_dist = __webpack_require__(36898);
...
const autoCloseTags = /*@__PURE__*/view_dist/* EditorView */.Lz.inputHandler.of((view, from, to, text, insertTransaction) => {
    ...
    let closeTags = state.changeByRange(range => {
        ...
        let after = (0,language_dist/* syntaxTree */.mv)(state).resolveInner(head, -1), name;
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $w: () => (/* binding */ lintKeymap)
/* harmony export */ });
/* unused harmony exports closeLintPanel, diagnosticCount, forEachDiagnostic, forceLinting, lintGutter, linter, nextDiagnostic, openLintPanel, previousDiagnostic, setDiagnostics, setDiagnosticsEffect */
/* harmony import */ var _codemirror_view__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(36898);
/* harmony import */ var _codemirror_state__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(31638);
/* harmony import */ var crelt__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(93748);
...
class LintState {
    ...
    static init(diagnostics, panel, state) {
        ...
        let deco = new _codemirror_state__WEBPACK_IMPORTED_MODULE_0__/* .RangeSetBuilder */ .vB(), active = [], pos = 0;
        for (let i = 0;;) {
            ...
            if (active.some(d => d.from == d.to || (d.from == d.to - 1 && state.doc.lineAt(d.from).to == d.from))) {
                deco.add(from, from, _codemirror_view__WEBPACK_IMPORTED_MODULE_1__/* .Decoration */ .NZ.widget({
                ...
                deco.add(from, to, _codemirror_view__WEBPACK_IMPORTED_MODULE_1__/* .Decoration */ .NZ.mark({
...
function maybeEnableLint(state, effects) {
    return state.field(lintState, false) ? effects : effects.concat(_codemirror_state__WEBPACK_IMPORTED_MODULE_0__/* .StateEffect */ .Pe.appendConfig.of(lintExtensions));
}
/**
...
*/
const setDiagnosticsEffect = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_0__/* .StateEffect */ .Pe.define();
const togglePanel = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_0__/* .StateEffect */ .Pe.define();
const movePanelSelection = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_0__/* .StateEffect */ .Pe.define();
const lintState = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_0__/* .StateField */ .sU.define({
    create() {
        return new LintState(_codemirror_view__WEBPACK_IMPORTED_MODULE_1__/* .Decoration */ .NZ.none, null, null);
    },
    update(value, tr) {
    ...
    provide: f => [_codemirror_view__WEBPACK_IMPORTED_MODULE_1__/* .showPanel */ .S7.from(f, val => val.panel),
        _codemirror_view__WEBPACK_IMPORTED_MODULE_1__/* .EditorView */ .Lz.decorations.from(f, s => s.diagnostics)]
});
/**
...
const activeMark = /*@__PURE__*/_codemirror_view__WEBPACK_IMPORTED_MODULE_1__/* .Decoration */ .NZ.mark({ class: "cm-lintRange cm-lintRange-active" });
...
function diagnosticsTooltip(view, diagnostics) {
    return (0,crelt__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)("ul", { class: "cm-tooltip-lint" }, diagnostics.map(d => renderDiagnostic(view, d, false)));
}
/**
...
const openLintPanel = (view) => {
    ...
    let panel = (0,_codemirror_view__WEBPACK_IMPORTED_MODULE_1__/* .getPanel */ .ld)(view, LintPanel.open);
    if (panel)
...
const lintConfig = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_0__/* .Facet */ .sj.define({
    combine(input) {
        return Object.assign({ sources: input.map(i => i.source).filter(x => x != null) }, (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_0__/* .combineConfig */ .QR)(input.map(i => i.config), {
            delay: 750,
            markerFilter: null,
            tooltipFilter: null,
            needsRefresh: null,
...
function renderDiagnostic(view, diagnostic, inPanel) {
    ...
    return (0,crelt__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)("li", { class: "cm-diagnostic cm-diagnostic-" + diagnostic.severity }, (0,crelt__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)("span", { class: "cm-diagnosticText" }, diagnostic.renderMessage ? diagnostic.renderMessage(view) : diagnostic.message), (_a = diagnostic.actions) === null || _a === void 0 ? void 0 : _a.map((action, i) => {
        ...
        let nameElt = keyIndex < 0 ? name : [name.slice(0, keyIndex),
            (0,crelt__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)("u", name.slice(keyIndex, keyIndex + 1)),
            name.slice(keyIndex + 1)];
        return (0,crelt__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)("button", {
            type: "button",
    ...
    }), diagnostic.source && (0,crelt__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)("div", { class: "cm-diagnosticSource" }, diagnostic.source));
}
class DiagnosticWidget extends _codemirror_view__WEBPACK_IMPORTED_MODULE_1__/* .WidgetType */ .xO {
    constructor(sev) {
        super();
        this.sev = sev;
    }
    ...
    toDOM() {
        return (0,crelt__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)("span", { class: "cm-lintPoint cm-lintPoint-" + this.sev });
    }
}
class PanelItem {
...
class LintPanel {
    constructor(view) {
        ...
        this.list = (0,crelt__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)("ul", {
            tabIndex: 0,
            role: "listbox",
        ...
        this.dom = (0,crelt__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)("div", { class: "cm-panel-lint" }, this.list, (0,crelt__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)("button", {
            type: "button",
            name: "close",
...
const baseTheme = /*@__PURE__*/_codemirror_view__WEBPACK_IMPORTED_MODULE_1__/* .EditorView */ .Lz.baseTheme({
    ".cm-diagnostic": {
...
class LintGutterMarker extends _codemirror_view__WEBPACK_IMPORTED_MODULE_1__/* .GutterMarker */ .wJ {
...
function markersForDiagnostics(doc, diagnostics) {
    ...
    return _codemirror_state__WEBPACK_IMPORTED_MODULE_0__/* .RangeSet */ .om.of(markers, true);
}
const lintGutterExtension = /*@__PURE__*/(0,_codemirror_view__WEBPACK_IMPORTED_MODULE_1__/* .gutter */ .cU)({
...
const lintGutterMarkers = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_0__/* .StateField */ .sU.define({
    create() {
        return _codemirror_state__WEBPACK_IMPORTED_MODULE_0__/* .RangeSet */ .om.empty;
    },
    update(markers, tr) {
...
const setLintGutterTooltip = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_0__/* .StateEffect */ .Pe.define();
const lintGutterTooltip = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_0__/* .StateField */ .sU.define({
    create() { return null; },
    update(tooltip, tr) {
    ...
    provide: field => _codemirror_view__WEBPACK_IMPORTED_MODULE_1__/* .showTooltip */ .DK.from(field)
});
const lintGutterTheme = /*@__PURE__*/_codemirror_view__WEBPACK_IMPORTED_MODULE_1__/* .EditorView */ .Lz.baseTheme({
    ".cm-gutter-lint": {
        width: "1.4em",
        "& .cm-gutterElement": {
            padding: ".2em"
...
const lintExtensions = [
    lintState,
    /*@__PURE__*/_codemirror_view__WEBPACK_IMPORTED_MODULE_1__/* .EditorView */ .Lz.decorations.compute([lintState], state => {
        let { selected, panel } = state.field(lintState);
        return !selected || !panel || selected.from == selected.to ? _codemirror_view__WEBPACK_IMPORTED_MODULE_1__/* .Decoration */ .NZ.none : _codemirror_view__WEBPACK_IMPORTED_MODULE_1__/* .Decoration */ .NZ.set([
            activeMark.range(selected.from, selected.to)
        ]);
    }),
    /*@__PURE__*/(0,_codemirror_view__WEBPACK_IMPORTED_MODULE_1__/* .hoverTooltip */ .Ux)(lintTooltip, { hideOn: hideTooltip }),
    baseTheme
];
const lintGutterConfig = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_0__/* .Facet */ .sj.define({
    combine(configs) {
...
/* harmony export */ });
/* unused harmony exports RegExpCursor, SearchCursor, SearchQuery, closeSearchPanel, findNext, findPrevious, getSearchQuery, gotoLine, openSearchPanel, replaceAll, replaceNext, search, searchPanelOpen, selectMatches, selectNextOccurrence, selectSelectionMatches, setSearchQuery */
/* harmony import */ var _codemirror_view__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(36898);
/* harmony import */ var _codemirror_state__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(31638);
/* harmony import */ var crelt__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(93748);
...
function createLineDialog(view) {
    ...
    }, (0,crelt__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)("label", view.state.phrase("Go to line"), ": ", input), " ", (0,crelt__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)("button", { class: "cm-button", type: "submit" }, view.state.phrase("go")), (0,crelt__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)("button", {
        name: "close",
        onclick: () => {
            view.dispatch({ effects: dialogEffect.of(false) });
            view.focus();
...
/* harmony export */ });
/* unused harmony exports InputStream, LocalTokenGroup, Stack */
/* harmony import */ var _lezer_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(90365);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  A: () => (/* binding */ src_plugin)
});

;// CONCATENATED MODULE: ./node_modules/@prettier/plugin-xml/src/languages.js
...
var api = __webpack_require__(20928);
;// CONCATENATED MODULE: ./node_modules/@prettier/plugin-xml/src/parser.js


const parser = {
  parse(text) {
    const { lexErrors, parseErrors, cst } = (0,api.parse)(text);
...
/* harmony default export */ const src_parser = (parser);
...
var public_default = (/* unused pure expression or super */ null && (public_exports));


;// CONCATENATED MODULE: ./node_modules/@prettier/plugin-xml/src/embed.js


const {
  dedentToRoot: embed_dedentToRoot,
  group: embed_group,
  hardline: embed_hardline,
  indent: embed_indent,
  join: embed_join,
  line: embed_line,
  literalline: embed_literalline,
  softline: embed_softline
} = builders;
...
function getElementTags(path, opts, print) {
  ...
  if (attribute) {
    parts.push(
      embed_indent([embed_line, embed_join(embed_line, path.map(print, "children", "attribute"))])
    );
  }

  if (!opts.bracketSameLine) {
    parts.push(embed_softline);
  }

  return {
    openTag: embed_group([...parts, START_CLOSE[0].image]),
    closeTag: embed_group([SLASH_OPEN[0].image, END_NAME[0].image, END[0].image])
  };
}
...
function embed_embed(path, opts) {
  const node = path.getValue();
  ...
  return async function (textToDoc, print) {
    ...
    return embed_group([
      openTag,
      embed_literalline,
      embed_dedentToRoot(utils.replaceEndOfLine(docNode)),
      embed_hardline,
      closeTag
    ]);
  };
...
/* harmony default export */ const src_embed = (embed_embed);

;// CONCATENATED MODULE: ./node_modules/@prettier/plugin-xml/src/printer.js



const { fill: printer_fill, group: printer_group, hardline: printer_hardline, indent: printer_indent, join: printer_join, line: printer_line, literalline: printer_literalline, softline: printer_softline } =
  builders;
...
function printCharData(path, opts, print) {
  ...
  return image
    .split(/(\n)/g)
    .map((value, index) => (index % 2 === 0 ? value : printer_literalline));
}
...
function printContent(path, opts, print) {
  ...
  return printer_group(fragments.map(({ printed }) => printed));
}
...
function printDocTypeDecl(path, opts, print) {
  ...
  return printer_group([...parts, CLOSE[0].image]);
}
...
function printCharDataPreserve(path, print) {
  ...
  path.each((charDataPath) => {
    ...
    if (
      ...
      prevFragment.printed = printer_group([prevFragment.printed, content]);
    } else {
      response.push({
...
function printCharDataIgnore(path) {
  ...
  path.each((charDataPath) => {
    ...
    const printed = printer_group(
      content.split(/(\n)/g).map((value) => {
        if (value === "\n") {
          return printer_literalline;
        }

        return printer_fill(
          value
            .split(/\b( +)\b/g)
            .map((segment, index) => (index % 2 === 0 ? segment : printer_line))
        );
      })
    );
...
function printElement(path, opts, print) {
  ...
  if (attribute) {
    ...
    const separator = opts.singleAttributePerLine ? printer_hardline : printer_line;
    parts.push(
      printer_indent([
        printer_line,
        printer_join(
  ...
  if (opts.bracketSameLine) {
    ...
    space = opts.xmlSelfClosingSpace ? printer_line : printer_softline;
  }

  if (SLASH_CLOSE) {
    return printer_group([...parts, space, SLASH_CLOSE[0].image]);
  }

  if (Object.keys(content[0].children).length === 0) {
    return printer_group([...parts, space, "/>"]);
  }

  const openTag = printer_group([
    ...parts,
    opts.bracketSameLine ? "" : printer_softline,
    START_CLOSE[0].image
  ]);

  const closeTag = printer_group([
    SLASH_OPEN[0].image,
    END_NAME[0].image,
    END[0].image
  ]);
  ...
  if (
    ...
    if (
      ...
      return printer_group([
        openTag,
        printer_indent([printer_softline, fragments[0].printed]),
        printer_softline,
        closeTag
      ]);
    }
    ...
    fragments.forEach((node) => {
      if (node.startLine - lastLine >= 2) {
        docs.push(printer_hardline, printer_hardline);
      } else {
        docs.push(printer_hardline);
      }
    ...
    return printer_group([openTag, printer_indent(docs), printer_hardline, closeTag]);
  }

  return printer_group([
    openTag,
    printer_indent(path.call(print, "children", "content", 0)),
    closeTag
  ]);
}
...
function printExternalID(path, opts, print) {
  ...
  if (System) {
    return printer_group([System[0].image, printer_indent([printer_line, SystemLiteral[0].image])]);
  }

  return printer_group([
    printer_group([Public[0].image, printer_indent([printer_line, PubIDLiteral[0].image])]),
    printer_indent([printer_line, SystemLiteral[0].image])
  ]);
}
...
function printProlog(path, opts, print) {
  ...
  if (attribute) {
    parts.push(
      printer_indent([printer_softline, printer_join(printer_line, path.map(print, "children", "attribute"))])
    );
  }

  return printer_group([
    ...parts,
    opts.xmlSelfClosingSpace ? printer_line : printer_softline,
    SPECIAL_CLOSE[0].image
  ]);
}

const printer_printer = {
  embed: src_embed,
...
/* harmony default export */ const src_printer = (printer_printer);

;// CONCATENATED MODULE: ./node_modules/@prettier/plugin-xml/src/plugin.js
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   GP: () => (/* binding */ su)
/* harmony export */ });
/* unused harmony exports __debug, check, default, doc, formatWithCursor, getSupportInfo, util, version */

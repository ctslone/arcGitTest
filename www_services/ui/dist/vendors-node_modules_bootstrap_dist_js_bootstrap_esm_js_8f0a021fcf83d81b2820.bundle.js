"use strict";
(self["webpackChunkcdata_arc"] = self["webpackChunkcdata_arc"] || []).push([["vendors-node_modules_bootstrap_dist_js_bootstrap_esm_js"],{
...
__webpack_require__.d(lib_namespaceObject, {
  afterMain: () => (enums/* afterMain */.EP),
  afterRead: () => (enums/* afterRead */.v5),
  afterWrite: () => (enums/* afterWrite */.SE),
  applyStyles: () => (modifiers_applyStyles),
  arrow: () => (arrow/* default */.A),
  auto: () => (enums/* auto */.qZ),
  basePlacements: () => (enums/* basePlacements */.OM),
  beforeMain: () => (enums/* beforeMain */.LG),
  beforeRead: () => (enums/* beforeRead */.ci),
  beforeWrite: () => (enums/* beforeWrite */.pA),
  bottom: () => (enums/* bottom */.sQ),
  clippingParents: () => (enums/* clippingParents */.WY),
  computeStyles: () => (computeStyles/* default */.A),
  createPopper: () => (popper_createPopper),
  createPopperBase: () => (createPopper/* createPopper */.n4),
  createPopperLite: () => (popper_lite_createPopper),
  detectOverflow: () => (detectOverflow/* default */.A),
  end: () => (enums/* end */._N),
  eventListeners: () => (eventListeners/* default */.A),
  flip: () => (flip/* default */.A),
  hide: () => (hide/* default */.A),
  left: () => (enums/* left */.kb),
  main: () => (enums/* main */.iW),
  modifierPhases: () => (enums/* modifierPhases */.GM),
  offset: () => (offset/* default */.A),
  placements: () => (enums/* placements */.DD),
  popper: () => (enums/* popper */.xf),
  popperGenerator: () => (createPopper/* popperGenerator */.UD),
  popperOffsets: () => (popperOffsets/* default */.A),
  preventOverflow: () => (preventOverflow/* default */.A),
  read: () => (enums/* read */.LF),
  reference: () => (enums/* reference */.ir),
  right: () => (enums/* right */.pG),
  start: () => (enums/* start */.ni),
  top: () => (enums/* top */.Mn),
  variationPlacements: () => (enums/* variationPlacements */.Ol),
  viewport: () => (enums/* viewport */.R9),
  write: () => (enums/* write */.M9)
});
...
var popper_lite_defaultModifiers = [eventListeners/* default */.A, popperOffsets/* default */.A, computeStyles/* default */.A, modifiers_applyStyles];
